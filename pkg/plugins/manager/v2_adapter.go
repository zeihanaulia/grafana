...
func DataSourceFromV2(v2 *pluginsV2.Plugin) *plugins.DataSourcePlugin {
...
func PanelFromV2(v2 *pluginsV2.Plugin) *plugins.PanelPlugin {
...
func AppFromV2(v2 *pluginsV2.Plugin) *plugins.AppPlugin {
